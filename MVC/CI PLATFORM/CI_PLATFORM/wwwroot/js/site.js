    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $.each(result, function (i, country) {
                let newOption = $('<option></option>').val(country.countryId).html(country.name).attr('id', country.name).attr('class', 'countrylist');
...
$('.countrylist').on('click', function () {
    ...
    var countryname = $(this).attr('value');
...
$('.c-dropdown ').on('change', function () {
    var cityid = $(this).attr('value');
    var cityname = $(this).attr('label');
