...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=PCI120\\SQL2017;DataBase=CI_PLATFORM;User ID=sa;Password=tatva123;Encrypt=False;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Admin>(entity =>
        {
            entity.HasKey(e => e.AdminId).HasName("PK__admin__43AA41413E37E4BC");
        ...
        {
            entity.HasKey(e => e.BannerId).HasName("PK__banner__10373C342DA44E6C");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A8BBA34A70");
        ...
        {
            entity.HasKey(e => e.CmsPageId).HasName("PK__cms_page__B46D5B52E0FEDFFD");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__comment__E795768751C0DD79");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD055C9FD349B");
        ...
        {
            entity.HasKey(e => e.FavouriteMissionId).HasName("PK__favourit__94E4D8CAFE4E67B1");
        ...
        {
            entity.HasKey(e => e.GoalMissionId).HasName("PK__goal_mis__358E02C7440C5BB4");
        ...
        {
            entity.HasKey(e => e.MissionId).HasName("PK__mission__B5419AB2A1A8D05E");
        ...
        {
            entity.HasKey(e => e.MissionApplicationId).HasName("PK__mission___DF92838A499454E2");
        ...
        {
            entity.HasKey(e => e.MissionDocumentId).HasName("PK__mission___E80E0CC81BCFF676");
        ...
        {
            entity.HasKey(e => e.MissionInviteId).HasName("PK__mission___A97ED1584183A958");
            ...
            entity.HasOne(d => d.ToUser).WithMany(p => p.MissionInviteToUsers)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_to_user_mission_invite");
        });

        modelBuilder.Entity<MissionMedium>(entity =>
        {
            entity.HasKey(e => e.MissionMediaId).HasName("PK__mission___848A78E8BA54475A");
        ...
        {
            entity.HasKey(e => e.MissionRatingId).HasName("PK__mission___320E517233577E0A");
            ...
            entity.HasOne(d => d.Mission).WithMany(p => p.MissionRatings)
                .HasForeignKey(d => d.MissionId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_mission_mission_rating");
        ...
        {
            entity.HasKey(e => e.MissionSkillId).HasName("PK__mission___82712008E6F6E5E7");
        ...
        {
            entity.HasKey(e => e.MissionThemeId).HasName("PK__mission___4925C5ACD1C37D54");
        ...
        {
            entity.HasKey(e => e.SkillId).HasName("PK__skill__FBBA837997841429");
        ...
        {
            entity.HasKey(e => e.StoryId).HasName("PK__story__66339C56C473DAC1");
        ...
        {
            entity.HasKey(e => e.StoryInviteId).HasName("PK__story_in__04497867995A29CE");
        ...
        {
            entity.HasKey(e => e.StoryMediaId).HasName("PK__story_me__29BD053C459DEFE1");
        ...
        {
            entity.HasKey(e => e.StoryViewId).HasName("PK__story_vi__A2F4803B169B19DA");
        ...
        {
            entity.HasKey(e => e.TimesheetId).HasName("PK__timeshee__7BBF506816C80597");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__user__B9BE370F2BE379E1");
        ...
        {
            entity.HasKey(e => e.UserSkillId).HasName("PK__user_ski__FD3B576BA9290550");
